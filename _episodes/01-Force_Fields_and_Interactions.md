...
> **GROMACS**
>
> The exclusions are generated by **grompp** as specified in the section **[ moleculetype ]** of the molecular topology **.top** file, e.g.:<br/><br/>
>[ moleculetype ]<br/>
>; name  nrexcl<br/>
>Urea         3
><br/><br/>
...
>
>
> The scaling factors for 1-4 pairs are specified in the **[ defaults ]** section of the **forcefield.itp** file.
>
> **fudgeLJ** and **fudgeQQ** are the force field specific multipliers for non-bonded interactions between 1-4 atoms.
>
>**fudgeLJ** is used only when **gen-pairs** is set to 'yes', **fudgeQQ** is always used.
>
{: .callout}
> **NAMD**
>
> Which pairs of bonded atoms should be excluded is specified by the **exclude** parameter. Acceptable Values:
>
